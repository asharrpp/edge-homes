...
export function AdminLoginForm() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const response = await fetch(`${backEndUrl}/auth/admin/sign-in`, {
				method: 'POST',
			...
			await deleteCookie(ADMIN_COOKIE_NAME);
			await createCookie({ name: ADMIN_COOKIE_NAME, value: data.accessToken });
			...
			if (redirectPath) {
				...
				router.push(configurations.urls.Admin.Dashboard); // Redirect to admin dashboard
			}
		} catch (error: any) {
		...
		<div className="w-full max-w-md mx-auto">
			<div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
				...
				<div className="bg-gradient-to-r from-gray-900 to-amber-700 p-8 text-center">
					...
					<p className="text-amber-100 text-sm">Edge Homes Management System</p>
				</div>
					...
					<div className="space-y-6">
						<div>
							...
							<input
								...
								placeholder="admin@edgehomes.com"
						...
						<div className="flex items-center justify-between">
							...
							<Link
								href={configurations.urls.Public.AdminForgetPassword}
								type="button"
